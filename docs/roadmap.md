# Health Tracker 9000 - Project Roadmap
...
| :--------- | :------------------- | :--------- | :----------------------------------------- |
| **0**      | Project Setup        | ✅ Done    | [Archive](./archive/completed-tasks.md)    |
| **1**      | Database & Mock Data | ✅ Done    | [Archive](./archive/completed-tasks.md)    |
| **2**      | Repositories         | ✅ Done    | [Archive](./archive/completed-tasks.md)    |
| **3**      | Business Logic       | ✅ Done    | [Archive](./archive/completed-tasks.md)    |
...
- [Development Reference & Conventions](./reference.md)
- [Original Monolith Archive](./archive/todo.md)
